...
const page = () => {
  const dummyData = [
    {
      address:
        "Ground Floor, Reliance Digital, Srikant Verma Marg, beside Rama Magneto Mall, Kranti Nager, Juna, Bilaspur, Chhattisgarh 495001",
      categories: [
        "Electronics store",
        "Appliance store",
      ...
      latitude: 22.070884,
      link: "https://www.google.com/maps/place/Reliance+Digital/data=!4m7!3m6!1s0x3a280bc262d1f0c5:0x22075e4909ffb62c!8m2!3d22.070884!4d82.150122!16s%2Fg%2F11rqkx28j2!19sChIJxfDRYsILKDoRLLb_CUleByI?authuser=0&hl=en&rclk=1",
      longitude: 82.150122,
      main_category: "Electronics store",
      name: "Reliance Digital",
      place_id: "ChIJxfDRYsILKDoRLLb_CUleByI",
      rating: 4.9,
      reviews: 10206,
    },
  ];
        ...
        <div className="mt-10 flex flex-col w-full">
          {loading ? (
            ...
            <>
              ...
              {dummyData.map((maps) => {
                return (
                  <CardContainer className="w-9/12">
                    <CardItem>
                      <CardBody className="flex w-9/12">
                        <div className="px-2">
                        ...
                        <a href={maps.link} target="_blank" rel="noreferrer">
